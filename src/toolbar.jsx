...
import { Button, OverlayTrigger, Tooltip, Modal, Navbar, Dropdown } from "react-bootstrap";
      ...
      <Navbar bg="dark" sticky="top" className="nav-toolbar">
        ...
        <Container>
          ...
          <Dropdown onSelect={(team) => onSelectTeam(team)}>
            ...
            <Dropdown.Menu>
              {teams.name.map(team=> <Dropdown.Item key={team} eventKey={team} className="team-dropdown-item">{team}</Dropdown.Item>)}
            </Dropdown.Menu>
          </Dropdown>
        </Container>
      </Navbar>
